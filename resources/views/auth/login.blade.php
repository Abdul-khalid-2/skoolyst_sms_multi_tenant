...
<head>
    ...
    <title>Login | {{ config('app.name', 'Your Application') }}</title>
        ...
        <div class="hidden lg:block w-1/2 bg-auth relative">
            <div class="absolute inset-0 bg-black/30 dark:bg-black/50 flex items-center justify-center">
                <div class="text-center px-10">
                    ...
                    <p class="text-xl text-gray-200">Sign in to access your dashboard and manage your account</p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    Or
                    <a href="{{ route('register') }}" class="font-medium text-primary-600 dark:text-primary-500 hover:text-primary-500 dark:hover:text-primary-400">
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <!-- Session Status -->
                    @if (session('status'))
                        <div class="mb-4 p-4 rounded-md bg-green-50 dark:bg-green-900 text-green-800 dark:text-green-200">
                            {{ session('status') }}
                        </div>
                    @endif
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember_me" name="remember" type="checkbox" 
                                    class="h-4 w-4 text-primary-600 dark:text-primary-500 focus:ring-primary-500 dark:focus:ring-primary-400 border-gray-300 dark:border-gray-700 rounded dark:bg-gray-900">
                            ...
                            @if (Route::has('password.request'))
                                <div class="text-sm">
                                    <a href="{{ route('password.request') }}" class="font-medium text-primary-600 dark:text-primary-500 hover:text-primary-500 dark:hover:text-primary-400">
